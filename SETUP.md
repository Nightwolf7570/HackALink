...
✅ LinkedIn profile scraping via ScraperAI  
✅ Rate limiting (10 requests/minute)  
✅ Heavy hitters identification using GPT-4  
...
- The app uses ScraperAI for compliant LinkedIn data access
- Rate limiting is built-in to prevent API abuse
- All analysis is done server-side via API routes

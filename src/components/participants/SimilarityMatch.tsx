      ...
      <div className="space-y-3">
        {matches.map((match, idx) => (
          <div 
            ...
            className="animate-fade-in p-4 bg-white rounded-xl border border-slate-200 hover:border-slate-300 transition-colors"
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-medium text-slate-900">{match.participant2Name}</h4>
                  <p className="text-xs text-slate-500">Similarity Match</p>
                </div>
              </div>

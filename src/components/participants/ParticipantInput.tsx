  ...
  return (
    <div className="card">
      <div className="p-6 space-y-6">
        {/* Header */}
        <div>
          <h2 className="text-base font-semibold text-slate-900">Import Participants</h2>
...
Bob Johnson"
          ...
          <div className="mt-3 space-y-2">
            <div className="flex items-start gap-2 text-xs text-slate-500">
              ...
              <span>
                Format: <code className="px-1.5 py-0.5 bg-slate-100 rounded text-slate-600">First Last</code> or <code className="px-1.5 py-0.5 bg-slate-100 rounded text-slate-600">First Last | LinkedIn URL</code>
              </span>
            </div>
            <div className="flex items-start gap-2 text-xs text-slate-500">
              <svg className="w-4 h-4 flex-shrink-0 mt-0.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
